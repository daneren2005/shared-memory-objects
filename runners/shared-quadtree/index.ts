...
// around the world for several rounds, all concurrently, hammering the per-node locks. Afterwards a full-world search
...
function checkIfDone() {
	...
	let all = tree.search(WORLD.x, WORLD.y, WORLD.width, WORLD.height);
