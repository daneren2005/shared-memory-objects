...
// around the world for several rounds, all concurrently, hammering the per-bucket locks. Afterwards a full-world search
...
function checkIfDone() {
	...
	let all = map.search(WORLD.x, WORLD.y, WORLD.width, WORLD.height);
