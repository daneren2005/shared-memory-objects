...
// build entry; the JS lands at dist/<path>.js and its declaration (emitted separately by `tsc
// --emitDeclarationOnly`, see package.json build) at dist/<path>.d.ts, which the wildcard `exports` in
// package.json maps together.
